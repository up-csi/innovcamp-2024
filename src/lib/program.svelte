<script>
    const tableArr = [
        ...
        { event: 'Workshop: Svelte Workshop', time: '06:30 PM - 08:30 PM' },
        { event: 'Closing', time: '08:30 PM - 09:00 PM' },
        { event: 'Egress', time: '09:00 PM' },
    ];
</script>
...
>
    ...
    <div class="my-4 grid w-11/12 rounded-3xl bg-[#D9D9D9] px-8 py-4 text-lg md:w-10/12 md:px-16 lg:w-7/12">
        {#each tableArr as row}
            <div class="inter my-4 flex justify-between">
